...
public class TileManager {
    ...
    public TileManager(gamePanel gp){
        ...
        tile = new Tile[20];
        getTileImage();
        mapTitleNum = new int[gp.maxScreenCol][gp.maxScreenRow];
    ...
    public void getTileImage() {
        ...
        try {
            ...
            tile[3] = new Tile();
            tile[3].image = ImageIO.read(getClass().getResourceAsStream("/Tiles/road01.png"));

            tile[4] = new Tile();
            tile[4].image = ImageIO.read(getClass().getResourceAsStream("/Tiles/road02.png"));

            tile[5] = new Tile();
            tile[5].image = ImageIO.read(getClass().getResourceAsStream("/Tiles/road03.png"));
    ...
    public void draw(Graphics2D g2){
        ...
        while (col < gp.maxScreenCol && row < gp.maxScreenRow){
            ...
            int tileNum = mapTitleNum[col][row];
